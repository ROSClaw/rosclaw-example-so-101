...
enum FollowerTopics {
    static let jointStates = "/follower/joint_states"
    static let cartesianGoal = "/follower/cartesian_goal"
    static let armTrajectoryAction = "/follower/arm_controller/follow_joint_trajectory"
    static let armTrajectoryActionType = "control_msgs/action/FollowJointTrajectory"
    static let armTrajectoryTopic = "/follower/arm_controller/joint_trajectory"
    static let gripperAction = "/follower/gripper_controller/gripper_cmd"
    static let gripperActionType = "control_msgs/action/GripperCommand"
    static let robotDescription = "/follower/robot_description"
    static let baseFrame = "follower/base_link"
    static let toolFrame = "follower/gripper_frame_link"
}
